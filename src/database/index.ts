...
export const initDatabase = (): Promise<void> => {
  if (useMock) {
    if (mockStudents.length === 0) {
      ...
      const l1: Lesson = { id: mockIdCounter++, studentId: s1.id, date: '2026-04-28', timeSlot: '14:00-16:00', duration: 2, amount: 300, paid: true, confirmedAt: '2026-04-28T16:00:00.000Z', notes: '导数章节', createdAt: '2026-04-28T10:00:00.000Z' };
      ...
      const l3: Lesson = { id: mockIdCounter++, studentId: s2.id, date: '2026-04-28', timeSlot: '10:00-12:00', duration: 2, amount: 400, paid: true, confirmedAt: '2026-04-28T12:00:00.000Z', notes: '阅读理解', createdAt: '2026-04-28T14:00:00.000Z' };
      ...
      const l11: Lesson = { id: mockIdCounter++, studentId: s1.id, date: '2026-04-15', timeSlot: '14:00-16:00', duration: 2, amount: 300, paid: true, confirmedAt: '2026-04-15T16:00:00.000Z', notes: '函数专题', createdAt: '2026-04-15T08:00:00.000Z' };
      const l12: Lesson = { id: mockIdCounter++, studentId: s2.id, date: '2026-04-16', timeSlot: '10:00-11:30', duration: 1.5, amount: 300, paid: true, confirmedAt: '2026-04-16T11:30:00.000Z', notes: '语法专项', createdAt: '2026-04-16T08:00:00.000Z' };
      const l13: Lesson = { id: mockIdCounter++, studentId: s3.id, date: '2026-04-18', timeSlot: '09:00-11:00', duration: 2, amount: 360, paid: true, confirmedAt: '2026-04-18T11:00:00.000Z', notes: '电学', createdAt: '2026-04-18T08:00:00.000Z' };
      const l14: Lesson = { id: mockIdCounter++, studentId: s1.id, date: '2026-04-20', timeSlot: '15:00-17:00', duration: 2, amount: 300, paid: true, confirmedAt: '2026-04-20T17:00:00.000Z', notes: '概率统计', createdAt: '2026-04-20T08:00:00.000Z' };
      const l15: Lesson = { id: mockIdCounter++, studentId: s2.id, date: '2026-04-22', timeSlot: '08:30-10:00', duration: 1.5, amount: 300, paid: true, confirmedAt: '2026-04-22T10:00:00.000Z', notes: '写作练习', createdAt: '2026-04-22T08:00:00.000Z' };
